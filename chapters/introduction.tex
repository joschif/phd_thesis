...
% Consider making this a section and expanding on it
...
% - In vitro organ models have revolutionized the study of human biology and disease. 
% - Especially the brain is hart to obtain tissue and manipulated
% - In the following section, I will outline different technologies to culture brain organoids, discuss how they model human brain development and their applcations. Lastly, I will discuss limitations and future directions of this technology
...
% + differences in differentiation and maturation...

These results demonstrate that organoid systems offer great potential as model systems of the human brain. The combination with genetic editing techniques and chemical screening will be especially powerful to study mechanisms of human brain development in health and disease.
...
% - Complex tissues -> resolution of composition requires single cell resolution
% - Technilogical advances allow us to meassure more and more features on a single cell level
% - Survey genomics of cell types in human tissues and the animal kingdom. 
% - Clustering -> annotation
% - Reference maps can be useful for diagnosing and understanging human diseases
% - Single cell resolution particularly useful for investigating developing systems 
% - Analyzing tissues at single-cell resolution is also critical for studying differentiation processes, because it allows us to capture all intermediate cell states between precursors and differentiated cells in a single snapshot. 
% - To determine which path cells take through developmental intermediates before they arrive at a mature state, differentiation trajectories can be computationally inferred. 
% - Cell-cell communication networks
% - Gene regulatory networks
% - In the following, I will outline techniques to measure various features of the genome in single cell and how these measurements can be combined to learn gene regulatory networks. I will discuss methods to manipulate and perturb cell behavior to reveal causal relationships and finally highlight future directions of the field of single cell genomics
...
% Rise of single cell RNA-seq
% Advantages of single cells
% Brief overview of omics layers
